...
\begin{definition}
	Covering geometric stacks are the smallest class containing contractible Types such that: If $Y$ is a sheaf and $\bT \ni S \to Y$ is fibered in covering geometric stacks, then $Y$ is a covering geometric stack.	
\end{definition}
